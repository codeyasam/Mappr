    ...
    <div class="container-fluid">
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="<?php echo MAPPR_PUBLIC_URL; ?>index.php">
          <img style="display: inline;margin-bottom: 5px;" src="<?php echo MAPPR_PUBLIC_URL; ?>images/coin_one_logo_small.png" alt="brand">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav navbar-right">
          ...
          <?php } ?> -->
          <li><a href="<?php echo MAPPR_PUBLIC_URL; ?>download.php"><span class="glyphicon glyphicon-download"></span> Downloads</a></li>
