	...
	<body>
		...
		<script type="text/javascript">
		    ...
		    $('#submit').on('click', function(e) {
		    	console.log("click: " + window.hasEmail);
		    	// if (password_comparison() === false || hasUsername == true || true == true) {
		    	// 	e.preventDefault();
		    	// }
		    	if (password_comparison() === false || window.hasEmail == "true" || window.hasUsername == "true") {
		    		e.preventDefault();
		    	}
		    });
